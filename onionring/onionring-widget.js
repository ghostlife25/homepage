...
<a href='https://ghostlife.org/issue001' style = 'margin: 0px 0px; background-color: #ffffff00; color:${linkTextColor}; text-decoration: underline;'>← previous</a>
  ...
  tag.insertAdjacentHTML('afterbegin', `
  <p><a href='${sites[previousIndex]}' style = 'margin: 0px 0px; background-color: #ffffff00; color:${linkTextColor}; text-decoration: underline;'>← previous</a></p>
  <p style = 'margin: 0px 0px; background-color: #ffffff00; color: ${ghostLifeTextColor};'>ghostlife 001 - page ${thisIndex + 1}</p>
  <p><a href='${sites[nextIndex]}' style = 'margin: 0px 0px; background-color: #ffffff00; color:${linkTextColor}; text-decoration: underline;'>next →</a></p>
  `);
