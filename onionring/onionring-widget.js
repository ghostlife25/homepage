...
<a href='https://ghostlife.org/issue001' style = 'margin: 0px 0px; background-color: ${ghostLifeBackgroundColor}; color:${linkTextColor}; text-decoration: underline;'>← previous</a>
  ...
  tag.insertAdjacentHTML('afterbegin', `
  <a href='${sites[previousIndex]}' style = 'margin: 0px 0px; background-color: ${ghostLifeBackgroundColor}; color:${linkTextColor}; text-decoration: underline;'>← previous</a>
  <p style = 'margin: 0px 0px; background-color: #ffffff00; color: ${ghostLifeTextColor};'>ghostlife 001 - page ${thisIndex + 1}</p>
  <a href='${sites[nextIndex]}' style = 'margin: 0px 0px; background-color: ${ghostLifeBackgroundColor}; color:${linkTextColor}; text-decoration: underline;'>next →</a>
  `);
...
document.getElementById("ghostlife001").style = `all: initial; width: 100%; height: 30px; position: fixed; bottom: 0; left: 0; right: 0; margin-left: 0; margin-right: 0; margin-bottom: 0; padding: 1px 1px; background-color: ${ghostLifeBackgroundColor}; display: flex; justify-content: space-around; align-items: center;`;
